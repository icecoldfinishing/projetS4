...
<body>
    ...
    <form class="form" action="<?= BASE_URL ?>/login" method="post">
        ...
        <div class="inputForm">
            ...
            <input type="text" class="input" name="prenom" value="Investisseur" placeholder="Entrez votre prénom">
        </div>
        </div>
        ...
        <div class="inputForm">
            ...
            <input type="password" class="input" name="pwd" value="mdp" placeholder="Entrez votre mot de passe"> <svg viewBox="0 0 576 512" height="1em" xmlns="http://www.w3.org/2000/svg">
